            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(editF)) {
                    try {
                        ...
                        Toast.makeText(B2.this, "Invalid Fahrenheit value", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(B2.this, "Please enter a Fahrenheit value", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(editC)) {
                    try {
                        ...
                        Toast.makeText(B2.this, "Invalid Celsius value", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(B2.this, "Please enter a Celsius value", Toast.LENGTH_LONG).show();
                }
            }
        });
